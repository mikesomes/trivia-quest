...
export default function CategoryScreen() {
  ...
  const handleSelect = async (categoryId: typeof CATEGORIES[0]['id']) => {
    ...
    setDifficulty('easy')
    try {
      await createRound.mutateAsync({ category: categoryId, difficulty: 'easy', difficultyMix: getClassicProgressionMix(0, GAME_CONFIG.QUESTIONS_PER_ROUND) })
            ...
            return (
              ...
              >
                ...
                <Text
                  style={[
                    styles.description,
                    cat.comingSoon && styles.descriptionDisabled,
                  ]}
                  numberOfLines={2}
                >
                  {cat.description}
